...
import { CardGroup, Deck, HandRanks } from './types.js';
import { calculateMaxIterations, cleanInput, validateInput } from './util.js';
export class Calculator {
    ...
    createBoardScenarions() {
        ...
        this.input.hands.forEach((h) => new CardGroup(h).cards.forEach((c) => deck.removeCard(c)));
